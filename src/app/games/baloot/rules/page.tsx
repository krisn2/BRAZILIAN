...
export default function BalootRulesPage() {
  const { t } = useLanguage();
      ...
      <div>
        ...
        <main className="text-white pt-[143px] pb-16 px-4 font-sans select-none flex flex-col items-center">
          <div className="max-w-[1165px] mx-auto flex flex-col items-center w-full">
            ...
            {/* --- HEADER SECTION --- */}
            <h1 
              className="font-serif tracking-[0.2em] font-bold uppercase text-center drop-shadow-md flex items-center justify-center min-w-[300px] px-4"
              style={{
                height: '27px',
                fontSize: '24px',
                lineHeight: '27px',
